 ...
 * @tparam Record record's value type
 */
...
class Dictionary {
 ...
 public:
   ...
   */
  virtual void insert(const Key &key, const Record &value) = 0;
   ...
   */
  virtual Record *find(const Key &key) = 0;
